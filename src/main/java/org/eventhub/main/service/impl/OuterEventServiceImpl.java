            ...
            for (Element link : doc.select(".cat_item__image")) {
                ...
                if (!visited.contains(next_link)) {
                    ...
                    if (dateStr.contains("-")) {
                        ...
                        String[] dateFirstSplit = strParts[0].split(" ");
                    ...
                    try {
                        String encodedAddress = URLEncoder.encode(location, StandardCharsets.UTF_8.toString());
                    ...
                    if (!geocodeResponse.getResults().isEmpty()) {
                        ...
                        System.out.println("Cannot get XY");
                    }
