...
import { editEventPhotos, editDataWithoutPhotos, deleteEvent,deleteEventPhotos } from "../../../api/editEventData";
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setSelectedCategories(eventData.category_responses?.map(category => category.name) || []);
